module.exports = {
  ...
  siteTitle: "Clipped.js", // Site title.
  siteTitleAlt: "Clipped.js - Make configuration great again", // Alternative site title for SEO.
  siteLogo: "/logos/Logo.svg", // Logo used for SEO and manifest.
  siteUrl: "https://clippedjs.github.io", // Domain of your website without pathPrefix.
  pathPrefix: "/", // Prefixes all links. For cases when deployed to example.github.io/gatsby-advanced-starter/.
  siteDescription: "Make configuration great again", // Website description used for RSS feeds/meta description tag.
  siteRss: "/rss.xml", // Path to the RSS file.
  siteFBAppID: "1825356251115265", // FB Application ID for using app insights
  googleAnalyticsID: "UA-108887459-2", // GA tracking ID.
  ...
  themeColor: "#4573de", // Used for setting manifest and progress theme colors.
  backgroundColor: "#e0e0e0", // Used for setting manifest background color.
  // TODO: Move this literally anywhere better.
  toCChapters: ["", "Guide", "Reference"] // Used to generate the Table Of Contents. Index 0 should be blank.
};
